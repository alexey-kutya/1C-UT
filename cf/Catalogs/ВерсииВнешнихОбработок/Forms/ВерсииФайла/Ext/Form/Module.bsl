...
//	ФайлОбъект.ИндексКартинки = Версия.ИндексКартинки;
	ФайлОбъект.ТекущаяВерсияРазмер = Версия.Размер;
	ФайлОбъект.ТекущаяВерсияДатаСоздания = Версия.ДатаСоздания;
	ФайлОбъект.ТекущаяВерсияАвтор = Версия.Автор;
	ФайлОбъект.ТекущаяВерсияРасширение = Версия.Расширение;
	ФайлОбъект.ТекущаяВерсияНомерВерсии = Версия.НомерВерсии;
	ФайлОбъект.ТекущаяВерсияКод = Версия.Код;
	ФайлОбъект.ТекущаяВерсияДатаМодификацииФайла = Версия.ДатаМодификацииФайла;
	ФайлОбъект.ТекущаяВерсияРазработчик = Версия.ТекущийРазработчик;
...
Процедура ЗаполнитьСписок()
	...
	|	ВерсииФайлов.ТекущийРазработчик
	|ИЗ
...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если ТекущиеДанные <> Неопределено Тогда 
		...
		ПараметрыОткрытияФормы = Новый Структура("Ключ", Версия);
		ОткрытьФорму("Справочник.ВерсииВнешнихОбработок.ФормаОбъекта", ПараметрыОткрытияФормы);

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВерсияПрограммы = Информация.ВерсияПриложения;
	ЭтоПлатформа835 = (Лев(ВерсияПрограммы, 5) = "8.3.5");
	Если ЗначениеЗаполнено(Параметры.ДатаОкончания) Тогда
		ОтборЖурналаРегистрации.Вставить("ДатаОкончания", Параметры.ДатаОкончания + ?(ЭтоПлатформа835, 1, 0));
	КонецЕсли;

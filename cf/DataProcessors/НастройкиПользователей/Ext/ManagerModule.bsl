...
Процедура ЗаполнитьСписокПрочихНастроек(Форма)
	...
	Если Ключи.Количество() > 0 Тогда
		...
		Если Не ПустаяСтрока(Форма.Поиск) Тогда
			Если Найти(ВРег(НСтр("ru='Персональные настройки'")), ВРег(Форма.Поиск)) = 0 Тогда
	...
	Если Не ПустаяСтрока(Форма.Поиск) Тогда
		...
		Если Найти(ВРег(НСтр("ru='Настройки печати табличных документов'")), ВРег(Форма.Поиск)) = 0 Тогда
			ВыводитьНастройку = Ложь;
		КонецЕсли;
	...
	Если Не ПустаяСтрока(Форма.Поиск) Тогда
		...
		Если Найти(ВРег(НСтр("ru='Избранное'")), ВРег(Форма.Поиск)) = 0 Тогда
			ВыводитьНастройку = Ложь;
		КонецЕсли;
	...
	Если Не ПустаяСтрока(Форма.Поиск) Тогда
		...
		Если Найти(ВРег(НСтр("ru='Прочие настройки'")), ВРег(Форма.Поиск)) = 0 Тогда
			ВыводитьНастройку = Ложь;
		КонецЕсли;

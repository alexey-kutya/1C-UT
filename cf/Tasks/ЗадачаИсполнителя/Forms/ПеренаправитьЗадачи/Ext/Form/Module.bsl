...
Функция ПараметрыЗакрытия()
	...
	Возврат Новый Структура("Исполнитель,РольИсполнителя,ОсновнойОбъектАдресации,ДополнительныйОбъектАдресации,Комментарий",
		...
		Роль,
//{{MRG[ <-> ]
		?((ОсновнойОбъектАдресации <> Неопределено И ОсновнойОбъектАдресации <> "") И НЕ ОсновнойОбъектАдресации.Пустая(), ОсновнойОбъектАдресации, Неопределено),
		?((ДополнительныйОбъектАдресации <> Неопределено И ДополнительныйОбъектАдресации <> "") И НЕ ДополнительныйОбъектАдресации.Пустая(), ДополнительныйОбъектАдресации, Неопределено),
//}}MRG[ <-> ]
//{{MRG[ <-> ]
